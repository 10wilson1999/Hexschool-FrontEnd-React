...
function ProductModal({
    ...
    useEffect(()=>{setTempData(templateData)},[templateData])
    ...
    const handleModalInputChange = (e) => {
      ...
      ...prevData, // 保留原有屬性
      [name]: type === "checkbox"? checked : value, // 更新特定屬性name、value
    }));
    };
                  ...
                  <div className="col-sm-4">
                    <div className="mb-2">
                      <div className="mb-3">
                        ...
                        <input className="form-control" type="file" id="fileUpload" name="fileUpload" accept=".jpg, .jpeg, .png" onChange={(e)=>uploadImage(e)}/>
                      </div>
                      <div className="mb-3">
          ...
          <div className="modal-footer">
            {
              modalType === "delete" ? (
                ...
                <>
                  ...
                  <button type="button" className="btn btn-primary" onClick={()=>updateProduct(templateData.id)}>確認</button>
                </>
              )
            }
          </div>
